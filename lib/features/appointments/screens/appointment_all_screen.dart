...
class _AllAppointmentForClientState extends State<AllAppointmentForClient>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      appointmentController.getAllAllAppointmentForEmployee("676297d66ec829a1a595dca6");
    });
  }
        ...
        if (appointmentController.errorMessage.isNotEmpty) {
          return ApiFailureWidget(onRetry: () {
            ...
            appointmentController
                .getAllAllAppointmentForEmployee("676297d66ec829a1a595dca6");
          });
        }
        ...
        return filteredAssessments.isEmpty
            ...
            : RefreshIndicator(
                ...
                onRefresh: () => appointmentController
                    .refreshAppointment("676297d66ec829a1a595dca6"),
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return AppointmentCard(
                      ...
                      onTap: () {
                        Get.dialog(AppointmentDialogDetails(appointmentModel: appointmentModel));
                      },
                    );
                  },
                ),
