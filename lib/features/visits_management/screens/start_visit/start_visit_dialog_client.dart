...
import '../../../qr-code-manage/screens/qr_code_generator_dialog.dart';

class StartVisitDialogClient extends StatefulWidget {
  final VisitModel visitModel;
  const StartVisitDialogClient({super.key, required this.visitModel});
  @override
  State<StartVisitDialogClient> createState() => _StartVisitDialogClientState();
}

class _StartVisitDialogClientState extends State<StartVisitDialogClient> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Starting a visit you have to scan the the qr code of the care professional or he has to scan the qr code of this visit',
