...
class ViewAllVisitScreen extends StatefulWidget {
  const ViewAllVisitScreen({super.key});

  @override
  State<ViewAllVisitScreen> createState() => _ViewAllVisitScreenState();
}

class _ViewAllVisitScreenState extends State<ViewAllVisitScreen>
