...
class EditPatientVitals extends StatefulWidget {
  final PatientVitalsModel patientVitalsModel;
  const EditPatientVitals({super.key, required this.patientVitalsModel});
  @override
  State<EditPatientVitals> createState() => _EditPatientVitalsState();
}

class _EditPatientVitalsState extends State<EditPatientVitals> {
  ...
  void initState() {
    super.initState();
    setState(() {
      _descriptionontroller.text = widget.patientVitalsModel.notes;
      _tempcontroller.text = widget.patientVitalsModel.temperature.toString();
      _bloodPressureSystoliccontroller.text =
          widget.patientVitalsModel.bloodPressure.systolic.toString();
      _bloodPressureDiastolicccontroller.text =
          widget.patientVitalsModel.bloodPressure.diastolic.toString();
      _heartController.text = widget.patientVitalsModel.heartRate.toString();
      _respiratoryController.text =
          widget.patientVitalsModel.respiratoryRate.toString();
      oxygencontroller.text =
          widget.patientVitalsModel.oxygenSaturation.toString();
      _timeController.text = widget.patientVitalsModel.recordedAt.toString();
    });
  }
                ...
                children: [
                  GeneralButton(
                    onTap: () {
                      ...
                      patientVitalHelper.validateAndEditForm(
                        visitId: widget.patientVitalsModel.id,
                        patientId: widget.patientVitalsModel.patientId.id,
                        ...
                        patientVitalsid: widget.patientVitalsModel.id,
                      );
                    },
