...
class ChatScreenEmployee extends StatefulWidget {
  final String groupId;
  final String employeeName;

  const ChatScreenEmployee(
      {super.key, required this.groupId, required this.employeeName});

  @override
  State<ChatScreenEmployee> createState() => _ChatScreenEmployeeState();
}

class _ChatScreenEmployeeState extends State<ChatScreenEmployee> {
  ...
  void initState() {
    ...
    chatController.connectSocket("${user!.id}", widget.groupId);
    chatController.getUsersInGroup(groupId: widget.groupId);
    super.initState();
  }
            ...
            child: Obx(
              () {
                if (chatController.isLoading.value) {
                  return const Center(
                    child: VehicleLoader(), // Display loader while loading
                  );
                }
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () => _chatHelpers.sendImage(
                    ...
                    userId: userId,
                    firstName: widget.employeeName,
                  ),
                ),
                Expanded(
                  child: TextField(
                    controller: chatController.messageController,
                    onChanged: (text) => chatController.notifyTyping(
                        widget.groupId, widget.employeeName),
