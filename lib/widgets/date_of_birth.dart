        ...
        return Theme(
          data: ThemeData(
            colorScheme: ColorScheme.light(
              primary: Pallete.originBlue, // Change the primary color to yellow
              onPrimary: Colors.white, // Text color on the primary color
              onSurface: Pallete.originBlue, // Text color on the surface
            ),
    ...
    return Column(
      ...
      children: [
        GestureDetector(
          ...
          child: AbsorbPointer( // Prevent typing, only allow date picker
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(10.0),
                  borderSide: BorderSide(color: Pallete.originBlue),
                ),
