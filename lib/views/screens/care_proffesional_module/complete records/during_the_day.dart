...
class DuringTheDay extends StatefulWidget {
  const DuringTheDay({super.key});

  @override
  State<DuringTheDay> createState() => _DuringTheDayState();
}

class _DuringTheDayState extends State<DuringTheDay> {
  @override
