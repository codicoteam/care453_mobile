...
import 'submit_drinks.dart';

class NotableActivities extends StatefulWidget {
  const NotableActivities({super.key});

  @override
  State<NotableActivities> createState() => _NotableActivitiesState();
}

class _NotableActivitiesState extends State<NotableActivities> {
  int numberOfCups = 0;
  int numberOfGlass = 0;
  int numberOfCan = 0;
  int numberOfMug = 0;
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 16.0, right: 16),
              child: Text(
                'List of notable activities that happened during the visit',
                style: GoogleFonts.poppins(
                  fontSize: 12,
                  fontWeight: FontWeight.w400,
                  color: Colors.grey.shade700,
