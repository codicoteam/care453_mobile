...
import 'urine_amount.dart';

class ObservePatientTwo extends StatefulWidget {
  const ObservePatientTwo({super.key});

  @override
  State<ObservePatientTwo> createState() => _ObservePatientTwoState();
}

class _ObservePatientTwoState extends State<ObservePatientTwo> {
  @override
